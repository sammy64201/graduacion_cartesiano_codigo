...
const char *nombreFaseRemota(uint8_t fase) {
    switch (fase) {
        ...
        case CAL_Z_MIN_1_R: return "BUSCANDO Z ABAJO";
        case CAL_Z_MIN_LIBERAR_R: return "LIBERANDO Z ABAJO";
        case CAL_Z_MIN_SEPARAR_R: return "SEPARANDO Z ABAJO";
        case CAL_Z_MIN_2_R: return "VERIFICANDO Z ABAJO";
        case CAL_Z_MAX_1_R: return "BUSCANDO Z ARRIBA";
        case CAL_Z_MAX_LIBERAR_R: return "LIBERANDO Z ARRIBA";
        case CAL_Z_MAX_SEPARAR_R: return "SEPARANDO Z ARRIBA";
        case CAL_Z_MAX_2_R: return "VERIFICANDO Z ARRIBA";
...
const char *textoErrorCal(uint8_t error) {
    switch (error) {
        ...
        case 4: return "RANGO Z INVALIDO";
        case 5: return "ERROR DE ESCALA";
...
void actualizarPantallaESP32(const PaquetePantalla &p) {
    ...
    const bool zCalibrado = (p.flags & FLAG_Z_CALIBRADO) != 0;
    ...
    const bool limiteZarriba = (p.limites & LIMITE_Z_ARRIBA_BIT) != 0;
    const bool limiteZabajo = (p.limites & LIMITE_Z_ABAJO_BIT) != 0;
    ...
    if (p.estado == MENU_PRINCIPAL_R) {
        ...
        pantalla.print(calibrado ? F("XY OK ") : F("XY NO "));
        pantalla.print(zCalibrado ? F("Z OK") : F("Z NO"));
    }
        ...
        pantalla.setCursor(0, 56);
        pantalla.print(F("ZA:"));
        pantalla.print(limiteZarriba ? "ON " : "OFF");
        pantalla.print(F(" ZB:"));
        pantalla.print(limiteZabajo ? "ON" : "OFF");
    }
        ...
        if (p.faseCal == CAL_ESPERA_R) {
            ...
            pantalla.println(F("HOME X=0 Y=0 Z=0"));
